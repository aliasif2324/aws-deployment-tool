...
def main():
	...
	try: 
		...
		execute_script_in_ec2_generic(ssh, ec2_instance, "a", "rm *.gz*")
		execute_script_in_ec2_generic(ssh, ec2_instance, "a", "rm *.zip")
		
		print (">>>>>>>>>>>>>>> STEP5 - Deploy  test script")
		deploy_to_aws(ssh, ec2_instance, "a", "b", ".tar.gz")
		
		print (">>>>>>>>>>>>>>> STEP6 - Deploy  driver script")
		deploy_to_aws(ssh, ec2_instance, "a", "driver", ".tar.gz")
		
		print (">>>>>>>>>>>>>>> STEP7 - Deploy  EVENTS_10856_111111001 script")
		# https://ucd1.s3.amazonaws.com/EVENTS_10856_111111001.csv.zip
		deploy_to_aws(ssh, ec2_instance, "a", "EVENTS_10856_111111001", ".csv.zip")
		...
		execute_script_in_ec2(ssh, ec2_instance, "a",  "b")
		print (">>>>>>>>>>>>>>> STEP9 - execute driver script")
		execute_script_in_ec2(ssh, ec2_instance, "a",  "problem2")
